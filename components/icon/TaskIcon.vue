<template>
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_193_15145)">
      <path d="M18 18H10V20H18V18Z" fill="blue" />
      <path d="M22 13H10V15H22V13Z" fill="blue" />
      <path d="M15 23H10V25H15V23Z" fill="blue" />
      <path
