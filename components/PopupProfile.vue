    ...
    <div class="w-[280px] h-[280px] border border-gray-300 rounded-md justify-center">
        ...
        <div class="mt-6">
            <NuxtLink to="/editProfile">
                <button class="w-[260px] bg-blue-500 text-white text-sm justify-center p-2 mx-2 my-2 rounded">Edit profil</button>
            </NuxtLink>
            <button class="w-[260px] border border-red-500 text-red-500 text-sm justify-center p-2 mx-2 my-2 rounded">Keluar</button>
        </div>
